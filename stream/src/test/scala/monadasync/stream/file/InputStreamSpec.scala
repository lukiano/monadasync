...
abstract class InputStreamSpec[F[_]: MonadSuspend: Monad: Catchable](runner: F ~> Id.Id) extends ImmutableSpec with ByteVectorArbitraries with ByteOps {

  private implicit val impRunner = runner
